...
public class MainActivity extends AppCompatActivity {
    ...
    private MultipartBody.Part getMultipartFromUri(String name, Uri uri) {
        ResourceUtils.getRealPath(MainActivity.this, uri);
        String path=uri.toString();
        File f = new File(path);
        //File f=new File("content://com.android.providers.media.documents/document/image%3A33");
    ...
    private void postVideo() {
        ...
        miniDouyinService.postVideo("13388605335", "卢子焰", coverImagePart, videoPart).enqueue(
            ...
            public void onResponse(Call<GetVideosResponse> call, Response<GetVideosResponse> response) {
                if (response.body() != null && response.body().videos != null) {
                    ...
                    for (int i=0;i<mVideos.size();i++){
                        if(mVideos.get(i).studentId.equals("13388605335"))
